...
description: >-
  Audit or rewrite mainland-China usage in Traditional Chinese into Taiwan 正體中文, including 陸用語, 簡體殘留, 職場／互聯網黑話, and Taiwan transliterations.
  Trigger on 「去除陸用語」「改成台灣用語」「抓簡體殘留」「把互聯網黑話改成正常中文」, "remove mainland Chinese wording", or "localize this to Taiwan Traditional Chinese".
  Not for AI-ism cleanup, document restructuring, plain-language explanation, creative writing, or code comments.
