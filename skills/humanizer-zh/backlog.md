...
- [ ] **第 47 條 2026-08-01 落地，三案齊備但一輪未跑。** 命中案 id 72 是作者提供的真語料，
  保護案 ids 73（消歧義優於防守）、74（來源註記是標註不是背書）都是合成。前者可用，後者受
  第 4a(4) 項的判定所限——保護類主張的是「真人會這樣寫，不准動」，用造出來的句子測等於用
  人味的演出代替人味本身。**待補：兩案的真語料替換**，方法章節或稽核報告裡真的宣告涵蓋範圍的
  段落最合適。
...
## `corpus.md` 的判定欄不帶資訊 — 2026-08-01 浮現，仍開放
...
- [ ] **實際狀況：真人桶 22 例全是 `ok`、AI 桶 12 例全是 `flag`，判定欄可以完全由桶別推出來。**
  也就是說，這一欄目前不帶任何資訊，量到的只有「skill 在真人文上安不安靜、在機生文上吵不吵」，
  ...
  體裁或作者，不是文字本身。曾用 2009 年交通部觀光拔尖領航方案核定本備好這樣一組（H-23／H-24），
  作者 2026-08-01 決定**移除所有政府計畫書語料**——那個體裁空泛文字太多，會混淆判斷——兩例
  已刪，缺口回到開放狀態。
...
- [ ] **正式文件語料的下一個來源：學術計畫。** 作者 2026-08-01 的判斷是學術計畫比政府計畫書
  ...
  只挑一眼就乾淨的段落。目前 `文體` enum 已含 `計畫書`（2026-08-01 加入），但檔內沒有任何一例
  使用它——留著是為了企業或學術計畫書進來時可以直接用。
